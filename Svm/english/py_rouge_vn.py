...
if __name__ == "__main__":
    ...
    for file in os.listdir(system_path):
        ...
        text_system = ' '.join(nltk.word_tokenize(open(file_name_system, 'r').read().strip().replace("\n", "")))

        file_name_human_1 = human_path + "cluster_" + id + "/summary_" + id + ".A.1.txt"
        text_human_1 = ' '.join(nltk.word_tokenize(open(file_name_human_1, 'r').read().strip().replace("\n", "")))

        file_name_human_2 = human_path + "cluster_" + id + "/summary_" + id + ".B.1.txt"
        text_human_2 = ' '.join(nltk.word_tokenize(open(file_name_human_2, 'r').read().strip().replace("\n", "")))

####
        file_name_human_3 = human_path + "cluster_" + id + "/summary_" + id + ".C.1.txt"
        text_human_3 = ' '.join(nltk.word_tokenize(open(file_name_human_1, 'r').read().strip().replace("\n", "")))

        file_name_human_4 = human_path + "cluster_" + id + "/summary_" + id + ".D.1.txt"
        text_human_4 = ' '.join(nltk.word_tokenize(open(file_name_human_2, 'r').read().strip().replace("\n", "")))

        arr_rouge_precision.append(rouge_1(text_system, [text_human_1, text_human_2, text_human_3, text_human_4], 1))
        arr_rouge_recall.append(rouge_1(text_system, [text_human_1, text_human_2, text_human_3, text_human_4], 0))
        arr_rouge_f1.append(rouge_1(text_system, [text_human_1, text_human_2, text_human_3, text_human_4], 0.5))
