...
SPECICAL_CHARACTER = {'(', ')', '[', ']', '”', '“', '*'}
SVM_FEATURES = '/home/hieupd/PycharmProjects/multi_summari_svm/svm_features'
...
class FeatureSvm(object):
    ...
    def get_all_feature_from_sentence(self, sentence, sentences, all_idf, bi_sentence, bi_all_idf):
        ...
        feature6 = self.extract_feature5_6(bi_sentence, bi_document, bi_all_idf) * 2
        feature7 = self.extract_feature7_8(sentence, document)
        feature8 = self.extract_feature7_8(bi_sentence, bi_document) * 2
        feature9 = self.extract_feature9(sentence, all_idf, sentences) * 1.5
