...
if __name__ == '__main__':
    ...
    path_data = '/home/hieupd/PycharmProjects/multi_summari_svm/data_labels/test'
    path_features = '/home/hieupd/PycharmProjects/multi_summari_svm/svm_features'
    f_test = []
    ...
    for name_clus, features in f_test:
        ...
        Y_test = []
        for fea in features:
            X_test.append(fea[2:].split(' ')) # [:9]
            Y_test.append(fea[0])
        prob_predic = evaluate_data(X_test)
        ...
        summari = mmr_selection.make_summary(sen_origin, length_summary, 0.8, idf, docs)
        ...
        f = open('/home/hieupd/PycharmProjects/multi_summari_svm/results/' + name_clus, 'w')
