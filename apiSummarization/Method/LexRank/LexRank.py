...
def getLexRank(documents, length_summary):
    lexRank = LexRank()
    doc_summary = []

    summary = lexRank.main(documents, length_summary)
...
if __name__ == '__main__':
    ...
    print(getLexRank([text_1, text_2, text_3], 100))
