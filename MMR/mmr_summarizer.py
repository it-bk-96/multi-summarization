...
def buildQuery(sentences, TF_IDF_w, n):
    ...
    # print sentence.sentence("query", queryWords, queryWords).getPreProWords()
    # print sentence.sentence("query", queryWords, queryWords).getWordFreq()
    ...
    for folder in os.listdir(main_data_path):
        ...
        if os.path.isdir(current_folder):
            ...
            for file in files:
                ...
                if file == '.gitkeep':
                    continue
                sentences = sentences + process_file(current_folder + "/" + file)
