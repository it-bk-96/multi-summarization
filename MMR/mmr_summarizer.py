...
if __name__ == '__main__':
	...
	main_folder_path = os.getcwd() + "/Data_DUC_2007/Documents"
	...
	for folder in os.listdir(main_folder_path):
		...
		# results_folder = os.getcwd() + "/Data_DUC_2004/MMR_results"
		results_folder = os.getcwd() + "/Data_DUC_2007/MMR_results"
