...
SPECICAL_CHARACTER = {'(', ')', '[', ']', '”', '“', '*'}
SVM_FEATURES = ROOT_DIR + '/method/English/SVM/Data/svm_features'
...
class FeatureSvm(object):
    ...
    def get_sentences(self):
        ...
        return text_utils.text_process(sentences)
    ...
    def extract_feature2(self, sentence):
        contain_first_paragraph = text_utils.get_sentence_first_paragraph(self.file_name)
...
if __name__ == "__main__":
    root = ROOT_DIR + "/method/English/SVM/Data/converted"
    ...
    documents = text_utils.read_all_documents(list_document_paths)
